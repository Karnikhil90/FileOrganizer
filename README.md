...
To organize your files, simply use the following command:
...
<br>
This command will list all files in the specified directory (`D:\\Downloads`). 

You can also use the following commands:

- `FO -h`: Show help information.
